...
accelerate launch --config_file configs/deepspeed_zero3.yaml --num_processes=1 --main_process_port 2950 spin/run_spin.py configs/config_iter3.yaml --learning_rate=1.0e-7 --beta=5.0 --warmup_ratio=0.1 --num_train_epochs=6 --output_dir="outputs/iter3-ckpt"
